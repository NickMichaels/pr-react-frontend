...
function PatientReferralsSent({ referralsSent, onDeleteReferral }) {
                ...
                <table class="table">
                    <thead>
                        <tr>
                            ...
                            <th scope="col">Receiving Provider</th>
                        ...
                        {referralsSent.length === 0 ? (
                            ...
                            referralsSent.map((referral, index) => (
                                <tr key={referral.id}>
                                    ...
                                    <td>{referral.receivingProviderName || 'N/A'}</td>
...
export default PatientReferralsSent